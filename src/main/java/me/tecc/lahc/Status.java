...
public enum Status {
    ...
    Unknown(-1, "Unknown HTTP Status Code", "Unknown or unsupported HTTP status code");

    private final int code;
    private final String name;
    private final String description;

    private static Map<Integer, Status> byCode;
     ...
     */
    public static Status getByCode(int httpStatus) {
     ...
     */
    public static Status getByCode(String httpStatus) {
        int statusCode;
        try {
